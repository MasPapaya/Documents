<div class="DocumentTypes">
	...
	<div>
		...
		<!--					<td><?php //  echo h($documentType['DocumentType']['is_multiple']);		        ?>&nbsp;</td>-->
						...
						<td class="actions">
							<div class="btn-group">
								<?php echo $this->Html->link('<i class="glyphicon glyphicon-pencil"></i>', array('action' => 'edit', $documentType['DocumentType']['id']), array('escape' => FALSE, 'class' => 'btn btn-default')) ?>
								<?php echo $this->Html->link('<i class="glyphicon glyphicon-eye-open"></i>', array('action' => 'view', $documentType['DocumentType']['id']), array('escape' => FALSE, 'class' => 'btn btn-default')) ?>
								...
								<?php
								echo $this->Form->postLink('<i class="glyphicon glyphicon-trash icon-white"></i>', array('action' => 'delete', $documentType['DocumentType']['id']), array('class' => 'btn btn-danger', 'escape' => FALSE), __('Are you sure you want to delete # %s?', $documentType['DocumentType']['name']));
								?>
							</div>
						</td>
					</tr>
