...
//		echo $this->Form->input('published', array('class' => 'datetime', 'type' => 'text'));
			...
			<div class="col-md-3">
				...
				<div class="btn-group">
					<?php echo $this->Js->link(__('Cancel'), '/admin/documents/Documents/index/' . $document['Document']['document_type_id'] . '/' . $document['Document']['parent_entityid'], array('class' => 'btn btn-default', 'escape' => FALSE, 'update' => "#" . $document['DocumentType']['alias'], 'value' => 'cancel')); ?>
